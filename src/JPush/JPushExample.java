...
public class JPushExample {
    ...
    protected static final String APP_KEY ="2bd1d6f333d2f9001b4f854b";
    protected static final String MASTER_SECRET = "bd481994798d8a8024b5ef33";
...
//	}
    ...
    public static void testSendPushWithCallback(String alias,String alert) {
	...
	public static void testSendPush(String alias,String alert) {
        ...
        try {
            ...
            Thread.sleep(5000);
            //濡傛灉浣跨敤 NettyHttpClient锛岄渶瑕佹墜鍔ㄨ皟鐢�close 鏂规硶閫�嚭杩涚▼
//            jpushClient.close();
